...
st.markdown("<p style='text-align: center;'>Scout, Recommend, Elevate Your Team's Game - 👀 </p>",
...
if choice:
    ...
    for column in columns_to_process:
        if isinstance(df_player[column][0], (list, dict)):
            df_player[column] = df_player[column].apply(
                lambda x: x[0] if isinstance(x, list) else (x if isinstance(x, dict) else x))
    ...
    selected_features = ['Pos', 'Age', 'Int',
                         ...
                         'Standard_Sh', 'Standard_SoT', 'Standard_SoT_', 'Standard_Sh_90', 'Standard_Dist',
                         'Standard_FK',
    ...
    url_player = \
    bing_image_urls(choice + " " + df_player.loc[df_player['Player'] == choice, 'Squad'].iloc[0] + " 2023", limit=1, )[
        0]
    ...
    with st.expander("Features of The Player selected", expanded=True):
        ...
        with col2:
            ...
            with col_2:
                ...
                st.metric("Match Played", df_player.loc[df_player['Player'] == choice, 'Playing_Time_MP'].iloc[0], None,
                          help="In 2022/2023")

            with col_3:
                st.metric("Age", df_player.loc[df_player['Player'] == choice, 'Age'].iloc[0], None)

            st.metric(f"🏆 League: {df_player.loc[df_player['Player'] == choice, 'Comp'].iloc[0]}",
                      df_player.loc[df_player['Player'] == choice, 'Squad'].iloc[0], None, help="In 2022/2023")
        ...
        with col3:
            ...
            if df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "GK":
                ...
                with col_1:
                    ...
                    st.metric("Clean Sheet", df_player.loc[df_player['Player'] == choice, 'Performance_CS'].iloc[0],
                              None)

                with col_2:
                    st.metric("Goals Against", df_player.loc[df_player['Player'] == choice, 'Performance_GA'].iloc[0],
                              None)
                    st.metric("ShoTA", df_player.loc[df_player['Player'] == choice, 'Performance_SoTA'].iloc[0], None)

            # DF
            if df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "DF" or \
                    df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "DF,MF" or \
                    df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "DF,FW":
                col_1, col_2, col_3 = st.columns(3)
                ...
                with col_2:
                    st.metric("Aerial Duel", df_player.loc[df_player['Player'] == choice, 'Aerial_Duels_Won'].iloc[0],
                              None)
                    st.metric("Tackle", df_player.loc[df_player['Player'] == choice, 'Tackles_TklW'].iloc[0], None,
                              help="In 2022/2023")
            ...
            # MF
            if df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "MF" or \
                    df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "MF,DF" or \
                    df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "MF,FW":
                col_1, col_2, col_3 = st.columns(3)
                ...
                with col_2:
                    ...
                    st.metric("Progressive PrgP",
                              df_player.loc[df_player['Player'] == choice, 'Progression_PrgP'].iloc[0], None,
                              help="In 2022/2023")
            ...
            # FW
            if df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "FW" or \
                    df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "FW,MF" or \
                    df_player.loc[df_player['Player'] == choice, 'Pos'].iloc[0] == "FW,DF":
                col_1, col_2, col_3 = st.columns(3)
                ...
                with col_2:
                    ...
                    st.metric("xAG", df_player.loc[df_player['Player'] == choice, 'Expected_xAG'].iloc[0], None,
                              help="In 2022/2023")
    ...
    with col2:
        ###### Radar Analytics #########################
        categories = ['Performance_Gls', 'Performance_Ast', 'KP', 'GCA_GCA', 'Aerial_Duels_Won', 'Int', 'Tackles_TklW',
                      'Performance_Saves', 'Performance_CS', 'Performance_GA', 'Performance_SoTA']
